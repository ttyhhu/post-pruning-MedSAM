...
from prune.new_fisher import compute_fisher_info
...
def search_mac(
    ...
    # head_mask = torch.zeros(num_hidden_layers * num_attention_heads)
    ...
    # neuron_mask = torch.zeros(num_hidden_layers * intermediate_size)
